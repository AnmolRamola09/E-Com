...
mongoose.connect(
  "mongodb+srv://anmol:anmol@cluster0.e4zgkuu.mongodb.net/e-commerce"
);
...
// Image Storage Engine  ( configured the disk storage )
...
app.get("/newcollections", async (req, res) => {
  let products = await Product.find({}); // fetch all products in products variable
...
app.post("/adminsignup", async (req, res) => {
  ...
  if (check) {
    return res.status(400).json({
      success: false,
      errors: "existing Admin found with same email id",
    });
  }
